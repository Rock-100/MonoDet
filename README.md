...
Please use the Detectron2 included in this project. To ignore fully occluded objects during training, [`build.py`](detectron2/data/build.py#L55), [`rpn.py`](detectron2/modeling/proposal_generator/rpn.py#L291), and [`roi_heads.py`](detectron2/modeling/roi_heads/roi_heads.py#L271) have been modified.
